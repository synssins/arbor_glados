        ...
        <div className="flex gap-1 border-b border-gray-200">
          {roots.map((root) => (
            ...
            >
              {root.label}
              {root.readonly && (
                <span className="ml-1 text-[10px] text-gray-400">(read-only)</span>
              )}
            </button>
          ))}
        </div>
              ...
              <>
                ...
                <div className="px-4 py-2 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <button onClick={closeFile} className="text-gray-400 hover:text-gray-600">
                ...
                {/* Status bar */}
                <div className="px-4 py-1 border-t border-gray-100 bg-gray-50 flex items-center justify-between text-[10px] text-gray-400">
                  <span>
